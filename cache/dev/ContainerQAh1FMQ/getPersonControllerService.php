...
class getPersonControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'PersonController.php';

        $container->services['App\\Controller\\PersonController'] = $instance = new \App\Controller\PersonController(($container->privates['App\\Repository\\PersonRepository'] ?? $container->load('getPersonRepositoryService')));
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'twig' => '?',
        ]))->withContext('App\\Controller\\PersonController', $container));
