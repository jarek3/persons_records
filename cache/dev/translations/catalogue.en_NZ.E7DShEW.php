...
$catalogue = new MessageCatalogue('en_NZ', array (
  'validators' => 
  array (
    'This value is not a valid toll-free number.' => 'This value is not a valid freephone number.',
  ),
));

$catalogueEn_001 = new MessageCatalogue('en_001', array (
));
$catalogue->addFallbackCatalogue($catalogueEn_001);
...
$catalogueEn_001->addFallbackCatalogue($catalogueEn);
