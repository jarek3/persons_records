...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'This value is not a valid phone number.' => 'Значение не является допустимым номером телефона.',
    'This value is not a valid fixed-line number.' => 'Значение не является допустимым номером фиксированной связи.',
    'This value is not a valid mobile number.' => 'Значение не является допустимым мобильным номером.',
  ),
  'security' => 
  array (
