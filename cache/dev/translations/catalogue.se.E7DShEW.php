...
$catalogue = new MessageCatalogue('se', array (
  'validators' => 
  array (
    'This value is not a valid phone number.' => 'Värdet är inte ett giltigt telefonnummer.',
    'This value is not a valid fixed-line number.' => 'Värdet är inte ett giltigt fast telefonnummer.',
    'This value is not a valid mobile number.' => 'Värdet är inte ett giltigt mobilnummer.',
  ),
));
