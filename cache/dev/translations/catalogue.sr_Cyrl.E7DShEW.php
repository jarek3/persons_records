...
$catalogueSr = new MessageCatalogue('sr', array (
  'validators' => 
  array (
    'This value is not a valid phone number.' => 'Вредност није валидан број телефона.',
    'This value is not a valid fixed-line number.' => 'Вредност није валидан број фиксне линије.',
    'This value is not a valid mobile number.' => 'Вредност није валидан број мобилног.',
  ),
));
