...
$catalogue = new MessageCatalogue('uk', array (
  ...
  array (
    ...
    'This value is not a valid phone number.' => 'Значення не є допустимим номером телефону.',
    'This value is not a valid fixed-line number.' => 'Значення не є допустимим номером фіксованого зв\'язку.',
    'This value is not a valid mobile number.' => 'Значення не є допустимим мобільним номером.',
  ),
  'security' => 
  array (
