...
class __TwigTemplate_6d7c3bdccd5f2d3870b0c0ebeb3ece0fd6ad14878fd2f447f6dfd654b1d2597a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_name($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, (isset($context["person_list"]) || array_key_exists("person_list", $context) ? $context["person_list"] : (function () { throw new RuntimeError('Variable "person_list" does not exist.', 3, $this->source); })()), "html", null, true);
...
{% block name %}{{ person_list }}{% endblock %}", "person/index.html.twig", "C:\\xampp\\htdocs\\persons_records\\templates\\person\\index.html.twig");
    }
}
